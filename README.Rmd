...
Within each group, if both an ancestor and a descendant node are present, only the **topmost** (ancestor) is used for elbow labelling and band placement; all valid IDs can still contribute labels at φ = 0 where their branches cross the baseline.
...
- group labels like `"g_5"` or combined node IDs if you defined union groups;
